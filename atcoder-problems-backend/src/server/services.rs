...
use crate::server::{
    auth::{get_token, Authentication},
    internal_user,
    language_count::get_language_list,
    problem_list::{
        add_item, create_list, delete_item, delete_list, get_own_lists, get_single_list,
    ...
    virtual_contest::{
        create_contest, get_my_contests, get_participated, get_recent_contests, get_single_contest,
        join_contest, leave_contest, update_contest, update_items,
    },
};
        ...
        web::scope("/internal-api")
            ...
            .service(
                web::scope("/list")
                    ...
                    .service(
                        web::resource("/get/{list_id}").route(web::get().to(get_single_list::<A>)),
                    )
                    ...
                    .service(
                        web::scope("/item")
                            ...
                            .service(
                                web::resource("/update").route(web::post().to(update_item::<A>)),
                            )
                            .service(
                                web::resource("/delete").route(web::post().to(delete_item::<A>)),
                            ),
                    ),
            )
            .service(
                web::scope("/contest")
                    ...
                    .service(
                        web::resource("/get/{contest_id}")
                            .route(web::get().to(get_single_contest::<A>)),
                    )
                    ...
                    .service(
                        web::resource("/recent").route(web::get().to(get_recent_contests::<A>)),
                    ),
            )
            .service(
                web::scope("/user")
                    ...
                    .service(
                        web::resource("/update").route(web::post().to(internal_user::update::<A>)),
                    ),
            )
            .service(
                web::scope("/progress_reset")
                    .service(
                        web::resource("/list").route(web::get().to(get_progress_reset_list::<A>)),
                    )
                    .service(
                        web::resource("/add").route(web::post().to(add_progress_reset_item::<A>)),
                    )
                    .service(
                        web::resource("/delete")
                            .route(web::post().to(delete_progress_reset_item::<A>)),
                    ),
            ),
    )
    .service(
                ...
                web::scope("/v3")
                    ...
                    .service(
                        web::resource("/streak_ranking").route(
                            web::get().to(<StreakRanking as RankingSelector<A>>::get_ranking),
                        ),
                    )
                    .service(
                    ...
                    .service(
                        web::resource("/from/{from}")
                            .route(web::get().to(get_time_submissions::<A>)),
                    )
                    .service(
                        web::resource("/recent").route(web::get().to(get_recent_submissions::<A>)),
                    )
                    .service(
                        web::resource("/users_and_time")
                            .route(web::get().to(get_users_time_submissions::<A>)),
                    )
                    .service(
                        web::scope("/user")
                            .service(
                                web::resource("/submissions")
                                    .route(web::get().to(get_user_submissions_from_time::<A>)),
                            )
                            .service(
                                web::resource("/submission_count")
                                    .route(web::get().to(get_user_submission_count::<A>)),
                            )
                            .service(web::resource("/ac_rank").route(
                                web::get().to(<AcRanking as UserRankSelector<A>>::get_users_rank),
                            ))
                            .service(
                                web::resource("/streak_rank")
                                    .route(web::get().to(
                                        <StreakRanking as UserRankSelector<A>>::get_users_rank,
                                    )),
                            )
                            .service(
                    ...
                    .service(
                        web::resource("language_list").route(web::get().to(get_language_list::<A>)),
                    ),
            ),
    )
