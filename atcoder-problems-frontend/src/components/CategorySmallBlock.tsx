...
export class CategorySmallBlock extends React.Component<CategorySmallBlockProps, {}>{
    render() {
        return (
            <Row>
                <PageHeader>Other Contests</PageHeader>
                {
                    this.props.data.map((d, index) => {
                        ...
                        return (
                            <div key={index}>
                                <strong>
                                    <a href={UrlFormatter.contestUrl(contest)}>
                                        {contest.title}
                                    </a>
                                </strong>
                                <Table striped bordered condensed hover><tbody><tr>{
                                    problems.map((problem, i) => (
                                        <td key={i}>
                                            <a href={UrlFormatter.problemUrl(contest, problem)} target="_blank">
                                                {problem.title}
                                            </a>
                                        </td>
                                    ))
