...
class PrimitiveNavigationBar extends React.Component<RouteComponentProps, State> {
				...
				<Nav className="ml-auto" navbar>
					...
					<UncontrolledDropdown nav inNavbar>
						...
						<DropdownMenu right>
							...
							<DropdownItem tag="a" href="https://github.com/kenkoooo/AtCoderProblems" target="_blank">
								GitHub
							</DropdownItem>
