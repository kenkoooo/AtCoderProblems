...
const problemToDifficultyLevel = (
  ...
  const difficulty: number | undefined = problemModels.getIn(
  ...
  if (difficulty === undefined) {
    ...
    return Math.floor(Math.min(DIFF_MAX, difficulty) / DIFF_WIDTH);
  }
};
      ...
      const difficultyLevelCounts = submissions
        ...
        .map(problemSubmissions =>
          problemSubmissions
            ...
            .map(problem => problemToDifficultyLevel(problem, problemModels))
            .first(undefined)
        )
