...
export default interface State {
  ...
  readonly contestToProblems: Map<ContestId, List<Problem>>;
  ...
  readonly agc: Map<ContestId, Contest>;
  readonly othersRated: Map<ContestId, Contest>;
  readonly others: Map<ContestId, Contest>;
